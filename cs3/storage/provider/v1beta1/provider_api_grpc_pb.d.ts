...
interface IProviderAPIService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  touchFile: IProviderAPIService_ITouchFile;
  ...
  setLock: IProviderAPIService_ISetLock;
  getLock: IProviderAPIService_IGetLock;
  refreshLock: IProviderAPIService_IRefreshLock;
  unlock: IProviderAPIService_IUnlock;
...
interface IProviderAPIService_ITouchFile extends grpc.MethodDefinition<cs3_storage_provider_v1beta1_provider_api_pb.TouchFileRequest, cs3_storage_provider_v1beta1_provider_api_pb.TouchFileResponse> {
...
interface IProviderAPIService_ISetLock extends grpc.MethodDefinition<cs3_storage_provider_v1beta1_provider_api_pb.SetLockRequest, cs3_storage_provider_v1beta1_provider_api_pb.SetLockResponse> {
  path: '/cs3.storage.provider.v1beta1.ProviderAPI/SetLock'
  requestStream: false
  responseStream: false
...
interface IProviderAPIService_IGetLock extends grpc.MethodDefinition<cs3_storage_provider_v1beta1_provider_api_pb.GetLockRequest, cs3_storage_provider_v1beta1_provider_api_pb.GetLockResponse> {
  path: '/cs3.storage.provider.v1beta1.ProviderAPI/GetLock'
  requestStream: false
  responseStream: false
...
interface IProviderAPIService_IRefreshLock extends grpc.MethodDefinition<cs3_storage_provider_v1beta1_provider_api_pb.RefreshLockRequest, cs3_storage_provider_v1beta1_provider_api_pb.RefreshLockResponse> {
  path: '/cs3.storage.provider.v1beta1.ProviderAPI/RefreshLock'
  requestStream: false
  responseStream: false
...
interface IProviderAPIService_IUnlock extends grpc.MethodDefinition<cs3_storage_provider_v1beta1_provider_api_pb.UnlockRequest, cs3_storage_provider_v1beta1_provider_api_pb.UnlockResponse> {
  path: '/cs3.storage.provider.v1beta1.ProviderAPI/Unlock'
  requestStream: false
  responseStream: false
